...
class ApplicationConfig:
    ...
    def __init__(self, logger, granularity_period):
        ...
        self.config_file = '/etc/config/amf-conf/supportedNssai.json'
        self.temp_SNSSAI_data = '__tmp/S-NSSAI_list'
        self.dcae_collector_ip_file_path = '/etc/config/amf-conf/dcae_collector_ip.txt'
        self.dcae_collector_port_file_path = '/etc/config/amf-conf/dcae_collector_port.txt'
        self.granularity_period_file_path = '/etc/config/amf-conf/granularity_period.txt'
        self.target_pm_directory = '/data/' + self.sftp_username + '/pm_directory/'

        self.measCollecFile_xmlns = 'http://www.3gpp.org/ftp/specs/archive/32_series/32.435#measCollec'
        ...
        self.managedElement_localDn = 'AMFMeasurement'
        self.measInfo_measInfoId = 'AMFFunction'
        self.measInfo_jobId = 'AMFJob9'
        ...
        self.measInfo_measType_text = 'RM.RegisteredSubNbrMean.'
