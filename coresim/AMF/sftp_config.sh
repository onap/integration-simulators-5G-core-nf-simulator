...
#Copy temporary config-file into the container

#mkdir /etc/config

#mkdir /etc/config/amf-conf

#mv ./config/amf-conf/supportedNssai.json /etc/config/

#mv ./config/amf-conf/dcae_collector_ip.txt /etc/config/amf-conf/

#mv ./config/amf-conf/dcae_collector_port.txt /etc/config/amf-conf/

#mv ./config/amf-conf/granularity_period.txt /etc/config/amf-conf/
