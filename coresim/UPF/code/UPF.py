...
def simulate_upf(application_config, param):
    '''
...
if __name__ == '__main__':
    ...
    logger.info('UPF Application started')

    if sys.argv[1] == 'UPF':
        while 1:
            with open('/etc/config/upf-conf/granularity_period.txt') as mytxt:
                for line in mytxt:
            ...
            simulate_upf(application_config, sys.argv[1])
