...
class ApplicationConfig:
    ...
    def __init__(self, logger, granularity_period):
        ...
        self.config_file = '/etc/config/upf-conf/supportedNssai.json'
        self.temp_SNSSAI_data = '__tmp/S-NSSAI_list'
        self.dcae_collector_ip_file_path = '/etc/config/upf-conf/dcae_collector_ip.txt'
        self.dcae_collector_port_file_path = '/etc/config/upf-conf/dcae_collector_port.txt'
        self.target_pm_directory = '/data/'+ self.sftp_username +'/pm_directory/'
        self.granularity_period = granularity_period
        ...
        self.managedElement_localDn = 'UPFMeasurement'
        self.measInfo_measInfoId = 'UPFFunction'
        self.measInfo_jobId = 'UPFJob10'
        ...
        self.measInfo_measType_value1 = '1'
        self.measInfo_measType_value2 = '2'
        self.measInfo_measType_value3 = '3'
        self.measInfo_measType_value4 = '4'
        self.measInfo_measType_text1 = 'GTP.InDataOctN3UPF.'
        self.measInfo_measType_text2 = 'GTP.OutDataOctN3UPF.'
        self.measInfo_measType_text3 = 'GTP.InDataOctN3UPFperTimePeriod.'
        self.measInfo_measType_text4 = 'GTP.OutDataOctN3UPFperTimePeriod.'
        self.measInfo_measValue_measObjLdn = 'some measObjLdn'
        self.measInfo_measValue_r_name = 'p'
        self.measInfo_measValue_r_value1 = '1'
        self.measInfo_measValue_r_value2 = '2'
        self.measInfo_measValue_r_value3 = '3'
        self.measInfo_measValue_r_value4 = '4'
