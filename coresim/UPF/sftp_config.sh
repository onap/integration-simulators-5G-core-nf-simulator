...
#mkdir /etc/config/upf-conf

#mv ./config/upf-conf/supportedNssai.json /etc/config/

#mv ./config/upf-conf/dcae_collector_ip.txt /etc/config/upf-conf/

#mv ./config/upf-conf/dcae_collector_port.txt /etc/config/upf-conf/

#mv ./config/upf-conf/granularity_period.txt /etc/config/upf-conf/
